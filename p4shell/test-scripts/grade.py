...
# Path to Batch Files
PBF = '/stage/classes/archive/{}/{}/15400-1/proj/p4/batch-files'.format(YEAR, QUARTER)
PEF = '/stage/classes/archive/{}/{}/15400-1/proj/p4/expected-output'.format(YEAR, QUARTER)
...
def isProcessExist(pname):
    proc1 = Popen(['pgrep', pname], stdout=PIPE, stderr=PIPE)
